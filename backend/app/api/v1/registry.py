...
def _spec(model, prefix, tag, create, update, search=None, sort="created_at", order="desc", activity_module=None):
...
SPECS = [
    ...
    _spec(camp.Camp, "/camps", "camps", s.CampCreate, s.CampUpdate, ["name", "location_text", "organiser"], "date", activity_module="camp"),
    ...
    _spec(reception.Feedback, "/feedback", "feedback", s.FeedbackCreate, s.FeedbackUpdate, ["source", "name", "comment", "action_taken"], "date"),
